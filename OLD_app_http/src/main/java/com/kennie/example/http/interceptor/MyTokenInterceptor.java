package com.kennie.example.http.interceptor;
...
import com.kennie.example.http.model.LoginCache;
import com.kennie.example.http.model.LoginInfo;
import com.kennie.example.http.token.TokenManager;
import com.kennie.example.http.utils.DateTimeUtils;
...
import com.kennie.library.http.interceptor.BaseExpiredInterceptor;
...
//                    case ComParamContact.Code.NO_ACCESS_TOKEN://缺少授权信息,没有accessToken,应该是没有登录
    ...
    public void refreshToken() throws IOException {
        KennieHttp.post(ComParamContact.Token.PATH)
...
//        originalResponse.body().close();
    ...
    private void reLogin() throws IOException {
        ...
        KennieHttp.post(ComParamContact.Login.PATH)
